    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row table-responsive">
                ...
                <a  class="btn btn-primary" href="{{route('withdraw::history')}}">History</a>
     ...
     <!--            <table data-sort-order="desc"
        ...
        @foreach($rows as $req)
                  <tr>
                    ...
                    <td><a href='{{route("withdraw::subStractPoints",["request_id"=>$req->id])}}' class="btn btn-primary">Done</a></td>
                </tr>           
       @endforeach 
