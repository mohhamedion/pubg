<div class="form-item row">
    ...
    <div class="form-item_body col-lg-8">
        <div class="row">
            <input type="range" min="50" max="100000" step="1"
                   value="50{{--{{ $application->limit > 10 ? $application->limit : $settings['application_downloads_min_limit'] }}--}}"
                   id="limit_range" title="@lang('labels.users_count')"/>
        </div>
        <div class="row">
            <div class="form-group form-group-info">
                ...
                <div class="col-md-3">
                    <input type="number" step="1"
                           value="50{{--{{ $application->limit > 10 ? $application->limit : $settings['application_downloads_min_limit'] }}--}}"
                           name="limit"
                           id="limit" class="form-control" min="50" max="50000" required
    ...
    <div class="form-item_body col-lg-8">
        <div class="row">
            <div class="time-delay">
                @php
                    $delays = [
                        72 * 60 * 60 => trans('labels.once'),
                    ];
                @endphp
                {!! Form::select('time_delay', $delays, 72 * 60 * 60, [
                        'id' => 'time_delay',
                        'style' => 'width: 100%',
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        @php
                            ...
                            ? number_format($prices->other_price_keywords, 2)
                            : number_format($prices->other_price, 2);
                        @endphp
